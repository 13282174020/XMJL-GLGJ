...
# 创建 API 路由模块
api_routes_content = '''# -*- coding: utf-8 -*-
"""模板管理 API 路由模块"""
...
with open('web_system/template_api.py', 'w', encoding='utf-8') as f:
    f.write(api_routes_content)
print('OK: web_system/template_api.py')

# 创建 API 路由测试文件
api_test_content = '''# -*- coding: utf-8 -*-
"""API 路由测试"""
import pytest
from pathlib import Path
import sys
...
with open('tests/test_template_api.py', 'w', encoding='utf-8') as f:
    f.write(api_test_content)
print('OK: tests/test_template_api.py')

# 创建集成测试文件
integration_test_content = '''# -*- coding: utf-8 -*-
"""集成测试"""
import pytest
from pathlib import Path
import sys
...
print('OK: tests/test_integration.py')
